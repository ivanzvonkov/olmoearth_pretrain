...
if __name__ == "__main__":
    ...
    # )
    tile_path = UPath("gs://ai2-helios/data/20250130-sample-dataset-helios")
    ...
    tiles = parse_helios_dataset(tile_path, supported_modalities)
    logger.info(f"Tiles: {len(tiles)}")
    samples = image_tiles_to_samples(tiles, supported_modalities)
