...
python scripts/joe/galileo.py launch galileo_large_repro_noema_ddp ai2/jupiter-cirrascale-2 --launch.priority=urgent --common.launch.num_gpus=8 --train_module.ema_decay=\[1,1\]
